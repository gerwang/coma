...
pca_outputs_orig = pca_orig.inverse_transform(pca_orig.transform(test_vertices_orig.reshape(test_vertices_orig.shape[0],-1)))
...
pca_vertices_orig*=1000

save_error_plt(cnn=cnn_vertices,pca=pca_vertices, orig=pca_vertices_orig, test=test_vertices, fname=opt.save+'/plt/'+os.path.basename(opt.data)+'.png')
